...
# Usage:    bash XR-polyA-seq_analysis_for_dm6.sh Read1 cores
#-------------------------------------------------------------------

# 设置所需变量接受参数
name=$(basename $1 ".fastq.gz")
ref=~/Tanyuanqing/Genome/dm6/bwa_index/dm6.fa
chrNamelength=~/Tanyuanqing/Genome/dm6/bwa_index/dm6.chrom.sizes
cores=$2
